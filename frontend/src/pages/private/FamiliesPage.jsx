      ...
      },
      {
        ...
        render: (row) => (
          <Button
            ...
            onClick={() => selectFamilyForUpdate(row)}
            type="button"
            variant="outline"
          >
    ...
    ? [
        {
          key: 'archive-family',
          label:
            resolutionActionKey === 'archive-family' ? 'Archivando familia...' : 'Archivar familia',
  ...
  return (
    <div className="grid gap-6">
      <div className="grid gap-6 2xl:grid-cols-[1fr_1fr]">
        <PanelCard>
          <PanelSectionHeader
            description="Base administrativa para contacto, seguimiento y articulación operativa."
            icon={FiHome}
          ...
          <form className="mt-6 grid gap-4 md:grid-cols-2" onSubmit={handleCreate}>
            <Field label="Nombre de referencia">
              <input
                ...
                onChange={updateCreateField('displayName')}
                required
        ...
        <PanelCard>
          <PanelSectionHeader
            ...
            description="Seleccioná una familia desde la tabla o el selector para cargar sus datos."
          ...
          <form className="mt-6 grid gap-4 md:grid-cols-2" onSubmit={handleUpdate}>
            ...
            <SelectionStateCard
              emptyText="Seleccioná una familia para habilitar la edición."
              lines={
                selectedFamily
                  ? [
                      `Contacto: ${selectedFamily.primaryContactName}`,
                      `Niños registrados: ${selectedFamily.children.length}`,
                    ]
                  : []
              }
            ...
            {selectedFamily ? (
              <>
                <Field label="Nombre de referencia">
                  <input
                    className="field-input"
                    onChange={updateUpdateField('displayName')}
                    required
                ...
                <Field label="Dirección">
                  <input
                    className="field-input"
                    onChange={updateUpdateField('address')}
                ...
                <Field label="Notas">
                  <textarea
                    className="field-input min-h-24"
                    onChange={updateUpdateField('notes')}
      ...
      <PanelCard>
        <PanelTableHeader
          countLabel={`${families.length} familias`}
          description="Hacé clic en una fila para cargarla en el panel de actualización."
